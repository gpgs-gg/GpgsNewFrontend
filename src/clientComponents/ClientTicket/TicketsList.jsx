...
import TicketMobileCardClient from "./TicketMobileCardClient";
  ...
  const handleExport = async () => {
    ...
    const ticketsToExport =
      selectedTickets.size > 0
        ? allTickets.filter((ticket) => selectedTickets.has(ticket.ticketId))
        : allTickets;
  ...
  return (
    <>
      <div className="space-y-5">
        ...
        {/* TABLE */}
        <div className="bg-white rounded-xl  md:border border-gray-500 shadow-sm overflow-hidden flex flex-col h-[75vh]">
          {/* SEARCH */}
          <div className="px-3 py-2 border-b border-gray-400 flex md:justify-between items-center gap-3 overflow-x-auto whitespace-nowrap">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {Object.keys(filters).length > 0 && (
                <button
                  onClick={handleReset}
                  className="border border-gray-300 px-3 py-2 rounded-lg text-red-500 flex items-center justify-center gap-2 text-sm flex-1 md:flex-none"
                >
                  {/* <Filter size={16} /> */}
                  Reset
                </button>
    ...
    ============================================================ */}
                        ...
                        >
                          ...
                          <td className="sticky right-0 z-20 bg-white p-3 shadow-md">
                            <div className="flex justify-center gap-2">
                              {/* <Link to={`/client-tickets/view/${item._id}`}>
        ...
        MOBILE CARDS
    ============================================================ */}
            <div className="md:hidden space-y-3 bg-gray-50">
              {isTicketData ? (
