...
const schema = yup.object({
    ...
    endDate: yup
        .string()
        .required("Existing property end date is required"),
});
const BedShiftModal = ({
    isOpen,
    onClose,
    ...
    // Business month = 30 days
    const businessMonthEnd = new Date(
        currentYear,
        currentMonth,
        30
    );
                ...
                <div className="flex items-center  justify-between px-4 py-4 border-b border-gray-300">
                    <div>
                        <h2 className="text-xl text-gray-800  font-semibold">
                            Property & Bed Shifting
                        </h2>
                        <p className="text-sm mt-1">
                            Existing Details : <span className="font-bold">{client?.fullName} / {client?.propertyId?.propertyCode} / {client?.bedId?.bedNo}</span>
                        </p>
                    </div>
                ...
                >
                    <div className="grid grid-cols-1 p-6 gap-4">
                        <Controller
                            ...
                            render={({ field }) => (
                                <div className={`select-group ${field.value ? "has-value" : ""}`}>
                                    <label className="select-label required-label">New Property Code</label>
                                    <Select
                                        {...field}
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <div className={`select-group ${field.value ? "has-value" : ""}`}>
                                    <label className="select-label required-label">New Bed No</label>
                                    <Select
                                        {...field}
                                        options={bedOptions}
                                        isClearable
                                    ...
                                    <DatePicker
                                        ...
                                        onChange={(date) => {
                                            ...
                                            if (date) {
                                                ...
                                                // 30th = business month end
                                                if (nextDay.getDate() === 30) {
                                                    nextDay.setDate(1);
