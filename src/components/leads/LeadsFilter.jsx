...
const LeadsFilter = ({
  ...
  useEffect(() => {
    ...
    reset({
      ...
      LeadStatus: initialFilters.LeadStatus || "",
      Assignee: initialFilters.Assignee || "",
      FieldMember: initialFilters.FieldMember || "",
      ...
      FollowupDate: initialFilters.FollowupDate
        ? new Date(initialFilters.FollowupDate)
        : null,
    });
  }, [
    isOpen,
    initialFilters.TeamCode,
    initialFilters.LeadSource,
    initialFilters.LeadStatus,
    initialFilters.Assignee,
    initialFilters.FieldMember,
    initialFilters.Reason,
    initialFilters.Gender,
    initialFilters.DateFrom,
    initialFilters.DateTo,
    initialFilters.FollowupDate,
    reset,
  ]);
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-96 bg-white z-50 shadow-xl transition-transform flex flex-col ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-5">
            ...
            />
            {renderSelect("TeamCode", "Team Code", teamCodeOptions)}

            {renderSelect("LeadSource", "Lead Source", leadSourceOptions)}

            {renderSelect("LeadStatus", "Lead Status", leadStatusOptions)}

            {renderSelect("Assignee", "Assignee", assigneeOptions)}

            {renderSelect("FieldMember", "Field Member", fieldMemberOptions)}

            {renderSelect("Gender", "Gender", genderOptions)}

            {renderSelect("Reason", "Reason", reasonOptions)}
