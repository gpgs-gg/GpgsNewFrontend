...
//                   <div>
//                     <p>
//                       <strong>Daily PG Facility Code :</strong>{" "}
//                       {data?.dailyPropertyId?.value?.split(",")[1]}
//                     </p>
...
//                       {formatDate(data?.dailyClientDoj)}
//                     </p>

//                     <p>
//                       <strong>Last Date :</strong>{" "}
//                       {formatDate(data?.dailyClientLastDate)}
//                     </p>
//                   </div>
...
//                   <div>
//                     <p>
//                       <strong>Daily Bed Rent Amount :</strong>{" "}
//                       ₹{" "}
//                       {Number(
//                         data?.dailyclientCalculatedRent || 0
//                       ).toLocaleString("en-IN")}
//                     </p>
...
//                       ₹{" "}
//                       {(
//                         (Number(data?.dailyclientCalculatedRent) || 0) +
//                         (Number(data?.dailyclientCalculatedRent) || 0)
//                       ).toLocaleString("en-IN")}
//                     </p>
//                   </div>
